...
> *The Sony Computer Entertainment boot screen, rendered from scratch*

## The emulators

### PlayStation 1 — [`psx/`](psx/README.md) · in development
...
### Game Boy (DMG) — [`gameboy/`](gameboy/README.md)
